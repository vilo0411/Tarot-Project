...
import styles from './five-cards-tarot.module.css';
...
function FiveCardsTarotPage() {
  ...
  // Tạo spread object cố định cho rút 5 lá
  const spreadType = {
  ...
  const analyzeReading = async () => {
    ...
    try {
      ...
      const spreadTypeValue = 'cross-spread';
...
export default FiveCardsTarotPage;